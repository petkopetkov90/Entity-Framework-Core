...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=(localdb)\MSSQLLocalDB;Database=TravelAgency;Integrated Security=True;Encrypt=False";
        ...
        public virtual DbSet<TourPackageGuide> TourPackagesGuides { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TourPackageGuide>()
                .HasKey(tp => new { tp.GuideId, tp.TourPackageId });
